...
HOW_IT_WORKS = (
    ...
    "5. You earn daily profits\n"
    "6. Every Sunday you can withdraw your <b>earnings</b>\n\n"
    "━━━━━━━━━━━━━━━━━━━━\n\n"
    "<b>Plan 1</b> — 50–250 TRX/USDT\n"
    "  18% profit over 60 days\n"
    "  Withdraw earnings after 40 days\n\n"
    "<b>Plan 2</b> — 251–450 TRX/USDT\n"
    "  20% profit over 60 days\n"
    "  Withdraw earnings after 30 days\n\n"
    "<b>Plan 3</b> — 451–650 TRX/USDT\n"
    "  22% profit over 60 days\n"
    "  Withdraw earnings after 13 days\n\n"
    "⚠️ <i>Your investment runs for the full 60 days.\n"
    "Capital is returned when the cycle ends.\n"
    "The days above are when your <b>earnings</b> become\n"
    "available for withdrawal — not your capital.</i>\n\n"
    "━━━━━━━━━━━━━━━━━━━━\n\n"
...
async def portfolio(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for inv in investments:
        ...
        lines.append(
            ...
            f"  Earnings withdrawable: <code>{inv['unlocks_at'][:10]}</code>\n"
            f"  Cycle ends: <code>{inv['expires_at'][:10]}</code>"
        )
